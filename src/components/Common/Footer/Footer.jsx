...
const Footer = () => {
    ...
    return (
        ...
        <>
            {showCTA && (
                <section className="bg-clr py-5 bg-strips">
                    ...
                    <div className="container text-center">
                        ...
                        <Link to="/contact" className=' bg-pry text-white text-decoration-none p-3 rounded-pill' type='button'>Contact Us Now</Link>
